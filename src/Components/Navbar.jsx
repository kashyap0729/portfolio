  ...
  return (
    <header className='header'>
        ...
        <nav className='nav-abc flex text-lg gap-7 font-medium'>
            <NavLink to="/portfolio/about" className={({isActive})=>isActive?
            'text-blue-500':'text-white'}>About</NavLink>
        </nav>
        <nav className='nav-abc flex text-lg gap-7 font-medium'>
            <NavLink to="/portfolio/projects" className={({isActive})=>isActive?
            'text-blue-500':'text-white'}>Projects</NavLink>
        </nav>
        <nav className='nav-abc flex text-lg gap-7 font-medium'>
            <NavLink to="/portfolio/contact" className={({isActive})=>isActive?
